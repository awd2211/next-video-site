...
const DirectorsList = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['directors', page, pageSize, ...Object.values(getSortParams())],
    queryFn: async () => {
      const response = await axios.get('/api/v1/admin/directors/', {
        params: {
          page,
          page_size: pageSize,
          ...getSortParams(),
      ...
      <div className="page-header">
        <div className="page-header-content">
          <div className="page-header-left">
            <h2 style={{ margin: 0, fontSize: '20px', fontWeight: 600 }}>导演管理</h2>
          </div>
