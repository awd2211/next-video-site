...
from app.admin import (
    ...
    system_settings as admin_system_settings,
...
app.include_router(admin_system_settings.router, prefix=f"{settings.API_V1_PREFIX}/admin/system", tags=["Admin - System Settings"])
